module github.com/voltrondata/pulumi-go-modules/AWS/eks

go 1.18

replace github.com/voltrondata/pulumi-go-modules/shared/utilities => ../utilities

require (
	github.com/pulumi/pulumi-aws/sdk/v5 v5.4.0
	github.com/pulumi/pulumi-eks/sdk v0.42.5
	github.com/pulumi/pulumi/sdk/v3 v3.36.0
	github.com/voltrondata/pulumi-go-modules/shared/utilities v0.1.0
)
